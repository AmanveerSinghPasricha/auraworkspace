"""
Aura Gateway Core - System Diagnostics Runner
=============================================
Directly tests Database connectivity, ORM schemas, and Graph compilation.
"""
...
async def run_diagnostics():
    ...
    print("1️⃣ Testing Database Pool Connection...")
    try:
    ...
    print("\n2️⃣ Testing LangGraph Compilation...")
    try:
